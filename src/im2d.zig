...
pub extern fn importbuffer_fd(fd: c_int, param: [*c]im_handle_param_t) rga_buffer_handle_t;
pub extern fn importbuffer_virtualaddr(va: ?*anyopaque, param: [*c]im_handle_param_t) rga_buffer_handle_t;
pub extern fn importbuffer_physicaladdr(pa: u64, param: [*c]im_handle_param_t) rga_buffer_handle_t;
pub extern fn releasebuffer_handle(handle: rga_buffer_handle_t) IM_STATUS;
pub extern fn wrapbuffer_handle_t(handle: rga_buffer_handle_t, width: c_int, height: c_int, wstride: c_int, hstride: c_int, format: c_int) rga_buffer_t;
pub extern fn wrapbuffer_virtualaddr_t(vir_addr: ?*anyopaque, width: c_int, height: c_int, wstride: c_int, hstride: c_int, format: c_int) rga_buffer_t;
pub extern fn wrapbuffer_physicaladdr_t(phy_addr: ?*anyopaque, width: c_int, height: c_int, wstride: c_int, hstride: c_int, format: c_int) rga_buffer_t;
pub extern fn wrapbuffer_fd_t(fd: c_int, width: c_int, height: c_int, wstride: c_int, hstride: c_int, format: c_int) rga_buffer_t;
pub extern fn imsetAlphaBit(buf: [*c]rga_buffer_t, alpha0: u8, alpha1: u8) void;
pub extern fn imsetOpacity(buf: [*c]rga_buffer_t, alpha: u8) void;
pub extern fn imsetColorSpace(buf: [*c]rga_buffer_t, mode: IM_COLOR_SPACE_MODE) void;
pub extern fn imsetOptGaussianBlur(opt: [*c]im_opt_t, gauss_width: c_int, gauss_height: c_int, sigma_x: c_int, sigma_y: c_int) void;
pub extern fn imsetOptGaussianBlurMatrix(opt: [*c]im_opt_t, gauss_width: c_int, gauss_height: c_int, matrix: [*c]f64) void;
pub extern fn improcess(src: rga_buffer_t, dst: rga_buffer_t, pat: rga_buffer_t, srect: im_rect, drect: im_rect, prect: im_rect, usage: c_int) IM_STATUS;
pub extern fn improcessOpt(src: rga_buffer_t, dst: rga_buffer_t, pat: rga_buffer_t, srect: im_rect, drect: im_rect, prect: im_rect, acquire_fence_fd: c_int, release_fence_fd: [*c]c_int, opt_ptr: [*c]im_opt_t, usage: c_int) IM_STATUS;
pub extern fn imcopy_t(src: rga_buffer_t, dst: rga_buffer_t, sync: c_int) IM_STATUS;
pub extern fn imresize_t(src: rga_buffer_t, dst: rga_buffer_t, fx: f64, fy: f64, interpolation: c_int, sync: c_int) IM_STATUS;
pub extern fn imcrop_t(src: rga_buffer_t, dst: rga_buffer_t, rect: im_rect, sync: c_int) IM_STATUS;
pub extern fn imtranslate_t(src: rga_buffer_t, dst: rga_buffer_t, x: c_int, y: c_int, sync: c_int) IM_STATUS;
pub extern fn imcvtcolor_t(src: rga_buffer_t, dst: rga_buffer_t, sfmt: c_int, dfmt: c_int, mode: c_int, sync: c_int) IM_STATUS;
pub extern fn imrotate_t(src: rga_buffer_t, dst: rga_buffer_t, rotation: c_int, sync: c_int) IM_STATUS;
pub extern fn imflip_t(src: rga_buffer_t, dst: rga_buffer_t, mode: c_int, sync: c_int) IM_STATUS;
pub extern fn imblend_t(srcA: rga_buffer_t, srcB: rga_buffer_t, dst: rga_buffer_t, mode: c_int, sync: c_int) IM_STATUS;
pub extern fn imcolorkey_t(src: rga_buffer_t, dst: rga_buffer_t, range: im_colorkey_range, mode: c_int, sync: c_int) IM_STATUS;
pub extern fn imquantize_t(src: rga_buffer_t, dst: rga_buffer_t, nn_info: im_nn_t, sync: c_int) IM_STATUS;
pub extern fn imrop_t(src: rga_buffer_t, dst: rga_buffer_t, rop_code: c_int, sync: c_int) IM_STATUS;
pub extern fn imfill_t(dst: rga_buffer_t, rect: im_rect, color: c_int, sync: c_int) IM_STATUS;
pub extern fn impalette_t(src: rga_buffer_t, dst: rga_buffer_t, lut: rga_buffer_t, sync: c_int) IM_STATUS;
pub extern fn imgaussianBlur_t(src: rga_buffer_t, dst: rga_buffer_t, gauss_width: c_int, gauss_height: c_int, sigma_x: c_int, sigma_y: c_int, sync: c_int) IM_STATUS;
pub extern fn imbegin(flags: u32) im_ctx_id_t;
pub extern fn imcancel(id: im_ctx_id_t) IM_STATUS;
pub extern fn improcess_ctx(src: rga_buffer_t, dst: rga_buffer_t, pat: rga_buffer_t, srect: im_rect, drect: im_rect, prect: im_rect, acquire_fence_fd: c_int, release_fence_fd: [*c]c_int, opt: [*c]im_opt_t, usage: c_int, ctx_id: im_ctx_id_t) IM_STATUS;
...
pub const _im2d_buffer_h_ = "";
pub fn wrapbuffer_handle(handle: rga_buffer_handle_t, width: c_int, height: c_int, format: c_int) rga_buffer_t {
    return wrapbuffer_handle_t(handle, width, height, width, height, format);
}
// pub const wrapbuffer_handle = @compileError("unable to translate C expr: expected ')' instead got '...'");
// ./include/im2d_buffer.h:101:9
pub const wrapbuffer_virtualaddr = @compileError("unable to translate C expr: expected ')' instead got '...'");
// ./include/im2d_buffer.h:117:9
pub const wrapbuffer_physicaladdr = @compileError("unable to translate C expr: expected ')' instead got '...'");
// ./include/im2d_buffer.h:133:9
pub const wrapbuffer_fd = @compileError("unable to translate C expr: expected ')' instead got '...'");
// ./include/im2d_buffer.h:149:9
pub const _im2d_single_h_ = "";
pub inline fn RGA_GET_MIN(n1: anytype, n2: anytype) @TypeOf(if (n1 < n2) n1 else n2) {
    _ = &n1;
    _ = &n2;
...
pub inline fn impyramid(src: anytype, dst: anytype, direction: anytype) @TypeOf(imresize_t(src, dst, if (direction == IM_UP_SCALE) @as(f64, 0.5) else @as(c_int, 2), if (direction == IM_UP_SCALE) @as(f64, 0.5) else @as(c_int, 2), IM_INTERP_DEFAULT, @as(c_int, 1))) {
    _ = &src;
    _ = &dst;
    _ = &direction;
...
// ./include/im2d_single.h:1013:9
pub const _im2d_task_h_ = "";
pub const _im2d_mpi_hpp_ = "";
pub const _im2d_expand_h_ = "";
