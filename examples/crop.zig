...
pub fn main() !void {
    ...
    const dst_format: usize = rga.RK_FORMAT_RGB_888;
    ...
    var param: im2d.im2d_type.im_handle_param_t = undefined;
    param.width = src_width;
    param.height = src_height;
    param.format = rga.RK_FORMAT_RGB_888;

    src_handle = im2d.im2d_buffer.importbuffer_virtualaddr(src_buf.ptr, &param);
    dst_handle = im2d.im2d_buffer.importbuffer_virtualaddr(dst_buf.ptr, &param);
    ...
    var crop_rec: im2d.im2d_type.im_rect = undefined;
    crop_rec.x = 256;
    crop_rec.y = 256;
    crop_rec.width = 480;
    crop_rec.height = 270;
    ret = im2d.im2d_single.imcrop(src_img, dst_img, crop_rec);
